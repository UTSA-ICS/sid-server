...
from sidserver.token.providers import common
from sidserver.token.providers.fernet import token_formatters as tf
...
class Provider(common.BaseProvider):
    ...
    def validate_v2_token(self, token_ref):
        ...
        :raises sidserver.exception.Unauthorized: if v3 token is used
    ...
    def validate_v3_token(self, token):
        ...
        :returns: the token data
        :raises sidserver.exception.Unauthorized: if token format version isn't
                                                 supported
    ...
    def _get_token_id(self, token_data):
        ...
        :raises sidserver.exception.NotImplemented: when called
        """
        raise exception.NotImplemented()
