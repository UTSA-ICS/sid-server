...
from sidserver.common import kvs
...
class Token(token.persistence.Driver):
    ...
    def __init__(self, backing_store=None, **kwargs):
        ...
        if self.__class__ == Token:
            ...
            LOG.warn(_LW('It is recommended to only use the base '
                         ...
                         'sidserver.token.persistence.backends.memcache.Token '
                         'or sidserver.token.persistence.backends.sql.Token '
                         'instead.'))
    ...
    def _add_to_revocation_list(self, data, lock):
        ...
        if not isinstance(token_list, list):
            ...
            # somehow the key is changed outside of sidserver (e.g. memcache
