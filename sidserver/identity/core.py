...
class DomainConfigs(dict):
    ...
    def _load_config_from_file(self, resource_api, file_list, domain_name):
        ...
        domain_config['cfg'](args=[], project='sidserver',
    ...
    def check_config_and_reload_domain_driver_if_required(self, domain_id):
        ...
        will get any config that has been updated from any other sidserver
        process.

        This cache-timeout approach works for both multi-process and
        multi-threaded sidserver configurations. In multi-threaded
...
class Manager(manager.Manager):
    ...
    See :mod:`sidserver.common.manager.Manager` for more details on how this
...
class Driver(object):
    ...
    def create_user(self, user_id, user):
        ...
        :raises: sidserver.exception.Conflict
    ...
    def get_user(self, user_id):
        ...
        :returns: user_ref
        :raises: sidserver.exception.UserNotFound
    ...
    def add_user_to_group(self, user_id, group_id):
        ...
        :raises: sidserver.exception.UserNotFound,
                 sidserver.exception.GroupNotFound
    ...
    def remove_user_from_group(self, user_id, group_id):
        ...
        :raises: sidserver.exception.NotFound
    ...
    def get_group(self, group_id):
        ...
        :returns: group_ref
        :raises: sidserver.exception.GroupNotFound
    ...
    def update_group(self, group_id, group):
        ...
        :raises: sidserver.exceptionGroupNotFound,
                 sidserver.exception.Conflict
