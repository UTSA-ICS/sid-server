...
from sidserver.i18n import _LE
...
class Driver(object):
    ...
    def create_region(self, region_ref):
        ...
        :raises: sidserver.exception.RegionNotFound (if parent region invalid)
    ...
    def get_region(self, region_id):
        ...
        :raises: sidserver.exception.RegionNotFound
    ...
    def get_service(self, service_id):
        ...
        :raises: sidserver.exception.ServiceNotFound
    ...
    def create_endpoint(self, endpoint_id, endpoint_ref):
        ...
        :raises: sidserver.exception.Conflict,
                 sidserver.exception.ServiceNotFound
    ...
    def get_endpoint(self, endpoint_id):
        ...
        :raises: sidserver.exception.EndpointNotFound
