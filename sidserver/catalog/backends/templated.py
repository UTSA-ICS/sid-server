...
from sidserver.catalog.backends import kvs
from sidserver.catalog import core
from sidserver import exception
from sidserver.i18n import _LC
...
class Catalog(kvs.Catalog):
    ...
    sidserver_compat will expect certain keys to be there so that it can munge
    them into the output format sidserver expects. These keys are:
