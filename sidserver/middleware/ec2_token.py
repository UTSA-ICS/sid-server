...
sidservermiddleware, `sidservermiddleware.ec2_token`.

"""

from sidservermiddleware import ec2_token
...
class EC2Token(ec2_token.EC2Token):
    ...
    @versionutils.deprecated(
        ...
        in_favor_of='sidservermiddleware.ec2_token.EC2Token',
        remove_in=+2,
        what='sidserver.middleware.ec2_token.EC2Token')
...
sidserver_ec2_opts = ec2_token.sidserver_ec2_opts
