...
from sidserver import assignment as sidserver_assignment
...
class Assignment(sidserver_assignment.Driver):

    def default_role_driver(self):
        return "sidserver.assignment.role_backends.sql.Role"

    def default_resource_driver(self):
        return 'sidserver.resource.backends.sql.Resource'
