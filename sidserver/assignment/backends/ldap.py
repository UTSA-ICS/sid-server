...
from sidserver.assignment.role_backends import ldap as ldap_role
from sidserver.common import ldap as common_ldap
from sidserver.common import models
from sidserver import exception
from sidserver.i18n import _
from sidserver.identity.backends import ldap as ldap_identity
...
class Assignment(assignment.Driver):
    @versionutils.deprecated(
        ...
        remove_in=+2,
        what='sidserver.assignment.backends.ldap.Assignment')
    def __init__(self):
    ...
    def default_role_driver(self):
        return 'sidserver.assignment.role_backends.ldap.Role'

    def default_resource_driver(self):
        return 'sidserver.resource.backends.ldap.Resource'
