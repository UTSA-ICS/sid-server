...
class Manager(manager.Manager):
    ...
    def get_roles_for_user_and_project(self, user_id, tenant_id):
        ...
        :raises: sidserver.exception.UserNotFound,
                 sidserver.exception.ProjectNotFound
    ...
    def get_roles_for_user_and_domain(self, user_id, domain_id):
        ...
        :returns: a list of role ids.
        :raises: sidserver.exception.UserNotFound,
                 sidserver.exception.DomainNotFound
    ...
    def add_user_to_project(self, tenant_id, user_id):
        ...
        :raises: sidserver.exception.ProjectNotFound,
                 sidserver.exception.UserNotFound
...
class Driver(object):
    ...
    def remove_role_from_user_and_project(self, user_id, tenant_id, role_id):
        ...
        :raises: sidserver.exception.RoleNotFound
    ...
    def check_grant_role_id(self, role_id, user_id=None, group_id=None,
        ...
        :raises: sidserver.exception.RoleAssignmentNotFound
...
class RoleManager(manager.Manager):
    ...
    def delete_role(self, role_id, initiator=None):
        try:
            ...
            # https://bugs.launchpad.net/sidserver/+bug/1221805
            pass
