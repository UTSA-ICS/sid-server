...
from sidserver.i18n import _, _LI, _LW
from sidserver.resource import controllers as resource_controllers
...
class Auth(controller.V3Controller):
    ...
    def check_token(self, context):
        ...
        # ``sidserver.common.wsgi.render_response`` will remove the content
        # body.
        return render_token_data_response(token_id, token_data)
...
# FIXME(gyee): not sure if it belongs here or sidserver.common. Park it here
# for now.
