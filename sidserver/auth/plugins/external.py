...
class ExternalDefault(DefaultDomain):
    """Deprecated. Please use sidserver.auth.external.DefaultDomain instead."""

    @versionutils.deprecated(
        as_of=versionutils.deprecated.ICEHOUSE,
        in_favor_of='sidserver.auth.external.DefaultDomain',
        remove_in=+1)
    def __init__(self):
...
class ExternalDomain(Domain):
    """Deprecated. Please use sidserver.auth.external.Domain instead."""

    @versionutils.deprecated(
        as_of=versionutils.deprecated.ICEHOUSE,
        in_favor_of='sidserver.auth.external.Domain',
        remove_in=+1)
    def __init__(self):
...
class LegacyDefaultDomain(Base):
    ...
    described here: https://bugs.launchpad.net/sidserver/+bug/1253484
