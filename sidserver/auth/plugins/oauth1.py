...
from sidserver.contrib.oauth1 import core as oauth
from sidserver.contrib.oauth1 import validator
...
class OAuth(auth.AuthMethodHandler):
    ...
    def authenticate(self, context, auth_info, auth_context):
        """Turn a signed request with an access key into a sidserver token."""
