...
from sidserver.i18n import _, _LE, _LW
...
class Driver(object):
    ...
    def get_project_by_name(self, tenant_name, domain_id):
        ...
        :returns: tenant_ref
        :raises: sidserver.exception.ProjectNotFound
    ...
    def get_domain(self, domain_id):
        ...
        :returns: domain_ref
        :raises: sidserver.exception.DomainNotFound
...
class DomainConfigManager(manager.Manager):
    ...
    def create_config(self, domain_id, config):
        ...
        :raises sidserver.exception.InvalidDomainConfig: when the config
    ...
    def get_config(self, domain_id, group=None, option=None):
        ...
        :raises sidserver.exception.DomainConfigNotFound: when no config found
    ...
    def delete_config(self, domain_id, group=None, option=None):
        ...
        :raises sidserver.exception.InvalidDomainConfig: when group/option
...
class DomainConfigDriver(object):
    ...
    def get_config_option(self, domain_id, group, option, sensitive=False):
        ...
        :returns: dict containing group, option and value
        :raises: sidserver.exception.DomainConfigNotFound: the option doesn't
                                                          exist.
