...
from sidserver.common import extension
...
# NOTE(blk-u): latest_app will be set by sidserver.service.loadapp(). It gets
# set to the application that was just loaded. In the case of sidserver-all,
# loadapp() gets called twice, once for the public app and once for the admin
# app. In the case of httpd/sidserver, loadapp() gets called once for the public
...
class Version(wsgi.Application):
    ...
    def _get_identity_url(self, context, version):
        """Returns a URL to sidserver's own endpoint."""
