...
# under the License.
"""Wrapper for sidserver.common.config that configures itself on import."""
...
from sidserver.common import config
...
def set_default_for_default_log_levels():
    """Set the default for the default_log_levels option for sidserver.
    ...
    extra_log_level_defaults = [
        'dogpile=INFO',
        'routes=INFO',
        'sidserver.common._memcache_pool=INFO',
    ]
...
def setup_logging():
    """Sets up logging for the sidserver package."""
    log.setup(CONF, 'sidserver')
...
def find_paste_config():
    ...
    For example::
        ...
        [paste_deploy]
        config_file = sidserver-paste.ini
    ...
    if CONF.paste_deploy.config_file:
        ...
        # this provides backwards compatibility for sidserver.conf files that
        ...
        paste_config = CONF.find_file('sidserver.conf')
        paste_config_value = 'sidserver.conf'
