...
from sidserver.auth import controllers as auth_controllers
from sidserver.common import authorization
from sidserver.common import controller
from sidserver.common import dependency
from sidserver.common import validation
from sidserver.common import wsgi
from sidserver.contrib.federation import idp as sidserver_idp
from sidserver.contrib.federation import schema
from sidserver.contrib.federation import utils
...
class Auth(auth_controllers.Auth):
    ...
    def _create_base_saml_assertion(self, context, auth):
        ...
        generator = sidserver_idp.SAMLGenerator()
    ...
    def create_ecp_assertion(self, context, auth):
        ...
        generator = sidserver_idp.ECPGenerator()
