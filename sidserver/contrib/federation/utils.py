...
class RuleProcessor(object):
    ...
    def __init__(self, rules):
        ...
        :class:`sidserver.tests.mapping_fixtures`
    ...
    def _update_local_mapping(self, local, direct_maps):
        ...
        :type direct_maps: sidserver.contrib.federation.utils.DirectMaps
    ...
    def _verify_all_requirements(self, requirements, assertion):
        ...
        :rtype: sidserver.contrib.federation.utils.DirectMaps
