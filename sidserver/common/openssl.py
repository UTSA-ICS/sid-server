...
from sidserver.i18n import _LI, _LE
...
class BaseCertificateConfigure(object):
    ...
    def __init__(self, conf_obj, server_conf_obj, sidserver_user,
                 sidserver_group, rebuild, **kwargs):
        self.conf_dir = os.path.dirname(server_conf_obj.ca_certs)
        self.use_sidserver_user = sidserver_user
        self.use_sidserver_group = sidserver_group
    ...
    def build_ssl_config_file(self):
        utils.make_dirs(os.path.dirname(self.ssl_config_file_name),
                        ...
                        user=self.use_sidserver_user,
                        group=self.use_sidserver_group, log=LOG)
...
class ConfigurePKI(BaseCertificateConfigure):
    ...
    def __init__(self, sidserver_user, sidserver_group, rebuild=False):
        super(ConfigurePKI, self).__init__(CONF.signing, CONF.signing,
                                           sidserver_user, sidserver_group,
                                           rebuild=rebuild)
