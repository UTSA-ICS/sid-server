...
from sidserver.common.kvs.core import *  # noqa
from sidserver.common.kvs.legacy import Base, DictKvs, INMEMDB  # noqa
...
region.register_backend(
    ...
    'sidserver.common.kvs.backends.inmemdb',
    'MemoryBackend')

region.register_backend(
    'openstack.kvs.Memcached',
    'sidserver.common.kvs.backends.memcached',
    'MemcachedBackend')
