...
from sidserver.i18n import _, _LE
...
dogpile.cache.register_backend(
    'sidserver.common.cache.noop',
    'sidserver.common.cache.backends.noop',
    'NoopCacheBackend')

dogpile.cache.register_backend(
    'sidserver.cache.mongo',
    'sidserver.common.cache.backends.mongo',
    'MongoCacheBackend')

dogpile.cache.register_backend(
    'sidserver.cache.memcache_pool',
    'sidserver.common.cache.backends.memcache_pool',
...
def get_should_cache_fn(section):
    ...
    For any given driver in sidserver that has caching capabilities, a boolean
...
def get_expiration_time_fn(section):
    ...
    For any given driver in sidserver that has caching capabilities, an int
