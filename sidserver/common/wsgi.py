...
def best_match_language(req):
    ...
    return req.accept_language.best_match(
        oslo_i18n.get_available_languages('sidserver'))
...
class BaseApplication(object):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            [app:wadl]
            latest_version = 1.3
            paste.app_factory = sidserver.fancy_api:Wadl.factory

        which would result in a call to the `Wadl` class as

            import sidserver.fancy_api
            sidserver.fancy_api.Wadl(latest_version='1.3')
...
class Middleware(Application):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            paste.filter_factory = sidserver.analytics:Analytics.factory

        which would result in a call to the `Analytics` class as

            import sidserver.analytics
            sidserver.analytics.Analytics(app, redis_host='127.0.0.1')
