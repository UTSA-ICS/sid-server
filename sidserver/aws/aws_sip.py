...
def __init__(self):
    self.sts_client = boto3.client('sts', aws_access_key_id=access_key_id, aws_secret_access_key=access_secret_key, aws_session_token=session_token)
    self.iam_client = boto3.client('iam', aws_access_key_id=access_key_id, aws_secret_access_key=access_secret_key, aws_session_token=session_token)
...
def assume_role(access_key_id, access_secret_key, role_arn, role_session_name, assume_role_policy):
    client = boto3.client('sts', aws_access_key_id=access_key_id, aws_secret_access_key=access_secret_key)
