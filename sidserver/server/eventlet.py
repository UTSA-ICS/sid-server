...
# sidserver.i18n._() is called to ensure it has the desired lazy lookup
# behavior. This includes cases, like sidserver.exceptions, where
# sidserver.i18n._() is called at import time.
oslo_i18n.enable_lazy()


from sidserver.common import environment
from sidserver.common import utils
from sidserver import config
from sidserver.i18n import _
from sidserver.openstack.common import service
from sidserver.openstack.common import systemd
from sidserver.server import common
from sidserver import service as sidserver_service
...
def create_server(conf, name, host, port, workers):
    app = sidserver_service.loadapp('config:%s' % conf, name)
...
def serve(*servers):
    logging.warning(_('Running sidserver via eventlet is deprecated as of Kilo '
